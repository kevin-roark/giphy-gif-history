export default [
  ...
  },
  {
    ...
    text: `
      ...
      and Mosaic. An advance in the compression algorithm allows for infinite looping.`,
    gifs: [
  ...
  },
  {
    time: '1994',
    text: `
      Geocities launches, giving people an easy way to create a personal website, decorated with GIFs available from
  ...
  },
  {
    ...
    title: 'Olia Lialina',
    text: `
      <div class="question">1. Where did you see your first GIF?</div>
      ...
      <div class="question">2. When did you make your first GIF?</div>
      1996. <a href="http://www.teleportacia.org/war/wind.gif">It’s this one</a>.

      <div class="question">3. What about the format initially appealed to you as a method for practice?</div>
      I needed some motion for the scenery for my piece “<i>My boyfriend came back from the war</i>.” Animated GIF was the only option at that time.

      <div class="question">4. Do you think GIFs have changed since you began working with them? If so, how?</div>
      ...
      <div class="question">5. What is your favorite GIF you have made?</div>
      ...
      <div class="question">6. What is your favorite GIF someone else has made?</div>
      ...
      <div class="question">7. In your opinion, what's next for the GIF, both in and out of art practice?</div>
  ...
  },
  {
    ...
    text: `
      ...
      <div class="question">2. When did you make your first GIF? Do you remember what it was?</div>
      ...
      <div class="question">3. What about the format initially appealed to you as a method for practice and why do you think the GIF has endured as a  medium for artists?</div>
  ...
  },
  {
    ...
    text: `
      ...
      causing a revolt among GIF lovers worldwide, who threaten to switch to PNGs. Although Unysis eventually backs down
  ...
  },
  {
    ...
    text: `
    <div class="question">1. Where did you see your first GIF?</div>
    On AOL somewhere. . .Or maybe Angelfire. I feel like it was an animated emoticon. I had seen so many still emoticons and i was really excited when i found out that it was possible for them to become animated. It brought so much life to the screen.
