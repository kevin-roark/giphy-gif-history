    ...
    var SuperGif = function ( opts ) {
        ...
        var doImg = function (img) {
            ...
            */
            ...
            if (drawWhileLoading) {
                ctx.drawImage(tmpCanvas, 0, 0,options.c_w,options.c_h);
        ...
        return {
            ...
            load_url: function(src,callback){
                ...
                //fixes strange CORS bug in chrome where XMLHTTPRequest on something already in <img> tag doesn't work b/c cache
                src = src;
